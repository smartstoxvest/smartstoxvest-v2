  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <input type="text" value={slugInput} onChange={e => setSlugInput(e.target.value)} placeholder="Slug" className="w-full p-2 border rounded" />
        <input type="text" value={tags} onChange={e => setTags(e.target.value)} placeholder="Tags" className="w-full p-2 border rounded" />
        <input type="text" value={author} onChange={e => setAuthor(e.target.value)} placeholder="Author" className="w-full p-2 border rounded" />
