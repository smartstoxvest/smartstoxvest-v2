    ...
    <>
      ...
      <section className="bg-blue-50 py-20 px-4 text-center">
        ...
        <div className="flex flex-col gap-4 max-w-md mx-auto">
          <Link to="/app/short-term" className="bg-blue-600 hover:bg-blue-700 text-white py-3 px-6 rounded-xl text-lg shadow transition text-center">
            📈 Short-Term Analysis
          </Link>
          <Link to="/app/medium-term" className="bg-purple-600 hover:bg-purple-700 text-white py-3 px-6 rounded-xl text-lg shadow transition text-center">
            🧠 Medium-Term Forecast
          </Link>
          <Link to="/app/long-term" className="bg-red-600 hover:bg-red-700 text-white py-3 px-6 rounded-xl text-lg shadow transition text-center">
            📉 Long-Term Risk
          </Link>
        </div>
      </section>
      ...
      {/* 🎯 Mission */}
      <section id="mission" className="py-20 bg-[#f4f7fb] text-center px-4">
      ...
      {/* 👥 Team */}
      <section id="team" className="py-20 bg-white text-center px-4">
        <h2 className="text-3xl font-bold text-blue-900 mb-4">About the Team</h2>
        <p className="text-gray-700 max-w-3xl mx-auto text-lg">
      ...
      {/* ⚙️ Features */}
      <section id="features" className="py-20 bg-[#f4f7fb]">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-blue-900 mb-10">What You Can Do with SmartStoxVest</h2>
      ...
      {/* 💬 Feedback */}
      {/* 💬 Feedback */}
<section id="feedback" className="py-20 bg-white px-4">
  <div className="max-w-xl mx-auto text-center">
    <h2 className="text-3xl font-bold text-blue-900 mb-6">We’d Love Your Feedback 💭</h2>
    ...
    >
      ...
      {/* 🔗 Footer + Share */}
      <footer className="bg-[#002d62] text-white py-10 text-center">
